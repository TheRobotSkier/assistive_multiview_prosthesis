...
run_test "ros_network" "$SCRIPT_DIR/test_ros_network_contracts.sh"
run_test "digital_twin" "$SCRIPT_DIR/test_digital_twin_contracts.sh"
run_test "hardware_bypass" "$SCRIPT_DIR/test_digital_twin_hardware_bypass_contracts.sh"
run_test "full_pipeline" "$SCRIPT_DIR/check_full_pipeline_contracts.sh"
run_test "segmentation" "$SCRIPT_DIR/test_segmentation_contracts.sh"
run_test "grasp" "$SCRIPT_DIR/test_grasp_contracts.sh"
run_test "final_camera" "$SCRIPT_DIR/test_final_camera_contracts.sh"
run_test "final_openvins" "$SCRIPT_DIR/test_final_openvins_contracts.sh"
