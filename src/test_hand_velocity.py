...
class HandVelocityTest(Node):
    ...
    def run(self):
        ...
        print("Loading and activating group_vel_ff_controller...")
        cm.ensure_controller_loaded("group_vel_ff_controller")
        # The load_controller service also configures in Jazzy, but the
        # controller manager may need a separate switch_controllers call
        # to claim interfaces and activate.  Deactivate position first.
