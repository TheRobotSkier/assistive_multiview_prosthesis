...
{
class PlannerGuiSystemInterface : public hardware_interface::SystemInterface
{
public:
  PlannerGuiSystemInterface();
...
#endif  // MIA_HAND_MUJOCO_PLANNER_GUI_SYSTEM_INTERFACE_HPP
