...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            name="aruco_marker_pose_cpp_node_arm_phase2",
            output="screen",
            condition=IfCondition(LaunchConfiguration("use_cpp_marker_pose")),
            parameters=[
                {"use_sim_time": LaunchConfiguration("use_sim_time")},
                {"image_topic": "/arm/d435i_arm/color/image_raw"},
                {"camera_info_topic": "/arm/d435i_arm/color/camera_info"},
                {"output_topic_prefix": "/arm/marker_pose"},
                {"output_topic": "/arm/marker_pose/observation"},
                {"target_frame": "arm_imu"},
                {"marker_map_frame": "marker_map"},
                {"camera_frame": "arm_d435i_arm_color_optical_frame"},
                {"marker_id": 0},
                ...
                # with the Kalibr arm calibration and marker map values.
            ],
        ),
    ])
