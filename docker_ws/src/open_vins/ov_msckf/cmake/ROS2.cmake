...
find_package(sensor_fusion_msgs REQUIRED)
...
add_executable(run_subscribe_msckf_marker src/run_subscribe_msckf_marker.cpp)
ament_target_dependencies(run_subscribe_msckf_marker ${ament_libraries})
target_link_libraries(run_subscribe_msckf_marker ov_msckf_lib ${thirdparty_libraries})
install(TARGETS run_subscribe_msckf_marker DESTINATION lib/${PROJECT_NAME})
